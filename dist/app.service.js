...
let AppService = class AppService {
    ...
    async payForTaskContract({ tokenId, address }) {
        ...
        if (_cost > this.trackerContract.balanceOf(address)) {
            return new common_1.BadRequestException('Err:NotEnoughBalance');
        }
        const taskCost = ethers_1.ethers.formatEther(_cost.toString());
    ...
    async fileuploadtoPinata() {
        ...
        console.log(...oo_oo(`724255913_143_4_143_38_4`, "==Form==>", formData));
        try {
            const JWT = this.configService.get('JWT', process.env.JWT);
            ...
            console.log(...oo_oo(`724255913_157_6_157_40_4`, "==IPHash>>", res.data));
            return res.data;
        }
        catch (error) {
